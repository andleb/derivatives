...
double PayoffCall::operator()(double p_spot) const { return std::max<double>(p_spot - m_strike, 0); }
...
double PayoffPut::operator()(double p_spot) const { return std::max<double>(m_strike - p_spot, 0); }
