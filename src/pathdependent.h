 ...
 * \date 4/2019
 *
 * Generalized path-dependent option classes.
 */
...
struct CashFlow
{
    ...
    //!  This member allows us to communicate which element in the series is/should be considered.
    size_t timeIndex;
};
...
public:
    ...
    //! the engine implementation according to \a lookAtTimes.
    //! \param p_spots
    //! \param p_flows
